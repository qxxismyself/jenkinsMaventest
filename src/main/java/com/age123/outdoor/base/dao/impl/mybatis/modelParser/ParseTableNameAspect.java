...
import com.age123.outdoor.base.dao.impl.mybatis.interceptor.RowBoundsInterceptor;
import com.age123.outdoor.base.dao.impl.mybatis.interceptor.SortListInterceptor;
...
public class ParseTableNameAspect {
	private static final Logger log = LoggerFactory.getLogger(ParseTableNameAspect.class);

    public ParseTableNameAspect() {
        log.info("ParseTableNameAspect 已构造");
    }

    @Around("execution(* com.age123.outdoor.base.dao.EntityDAO.*(..))")
