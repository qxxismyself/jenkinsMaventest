...
import com.age123.outdoor.base.dao.complexQuery.NoValueQueryParam;
import com.age123.outdoor.base.dao.complexQuery.Sort;
import com.age123.outdoor.base.dao.complexQuery.WithValueQueryParam;
import com.age123.outdoor.base.dao.impl.mybatis.modelParser.ColumnTarget;
import com.age123.outdoor.base.dao.impl.mybatis.modelParser.ModelUtils;
import com.age123.outdoor.base.dao.impl.mybatis.modelParser.Property;
import com.age123.outdoor.base.model.Entity;
import com.age123.outdoor.base.model.EntityWithTime;
import com.age123.outdoor.util.ReflectUtils;

public class BaseSQLProvider<T extends Entity> {

	private static final Logger log = LoggerFactory.getLogger(BaseSQLProvider.class);
		...
		return new SQL() {
			{
				...
				try {
					Map<String, Property> properties = ModelUtils.getProperties(Class.forName(className),
							ColumnTarget.UPDATE);
	...
	public static SQL WHERE_CUSTOM(SQL sql, Class modelClass, Map<String, Object> dataMap,
			List<CustomQueryParam> customQueryParams, String tableAlias) {
		...
		for (CustomQueryParam customQueryParam : customQueryParams) {
			...
			if (customQueryParam instanceof WithValueQueryParam) {
				...
				condition = condition + property.getColumnName() + " " + withValueQueryParam.getOperator() + " #{"
						+ (dataMap.size() - 1) + "}";
				// i++;
